...
export default function ArticleEditorForm({ article }: Props) {
  ...
  const [status, setStatus] = useState<'draft' | 'published' | 'scheduled'>(article?.status || 'draft');
        ...
        <div className="space-y-5">
          <div className="card p-4 space-y-4">
            ...
            <div>
              ...
              <select value={status} onChange={e => setStatus(e.target.value as 'draft' | 'published' | 'scheduled')} className="input">
